...
import { FiBell, FiMenu, FiX, FiHome, FiUsers, FiFolder, FiBookOpen, FiLogOut, FiUser, FiSettings, FiChevronDown } from "react-icons/fi";
...
const TeacherNavbar = () => {
  ...
  const navLinks = [
    ...
    //{ path: "/teacher/projects", label: "Projects", icon: FiFolder },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          {/* CENTER - Desktop Navigation with active indicators */}
            ...
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-blue-400 to-purple-400"></span>
                  )}
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            {/* Notification Bell with enhanced design */}
            ...
            {/* Avatar Dropdown with enhanced design */}
            <div className="relative">
              ...
              >
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center font-bold text-white shadow-lg group-hover:shadow-xl group-hover:scale-105 transition-all duration-200">
        ...
        <div className="px-4 py-3 space-y-1">
          ...
          <div className="px-4 py-3 mt-2 border-t border-white/10">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-full bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center font-bold text-white">
                {user?.name?.charAt(0) || 'T'}
              </div>
              <div>
          ...
          <button
            ...
            className="w-full flex items-center space-x-3 px-4 py-3 text-red-300 hover:bg-red-500/10 rounded-lg transition-all duration-200"
          >
